...
public class ReportService {
    ...
    public ReportService(ReportRepository reports, UserRepository users, AdoptionRequestRepository adoptions) {
    ...
    public void deleteByClient(User user, Long id) {
        ...
        // ⚠️ se existirem adoption_requests, aqui também pode estourar FK
        // (adminDelete já trata disso)
        reports.delete(r);
    }
    ...
    public void adminDelete(Long reportId) {
        // apaga filhos primeiro para respeitar FK
